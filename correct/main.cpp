...
int main() {
    ...
    ascii_to_binary('4',binary);
    cout << "The ASCII code of '4' is " << int('4') << " which in binary is " << binary << endl << endl;

    ascii_to_binary('0',binary);
    cout << "The ASCII code of '0' is " << int('0') << " which in binary is " << binary << endl << endl;

    char ch;
    ch = binary_to_ascii("01000001");
    cout << "The character correspoding to the binary number 01000001 is '" << ch << "'" << endl << endl;

    ch = binary_to_ascii("0011110");
    cout << "The character correspoding to the binary number 0011110 is '" << ch << "'" << endl << endl;
