...
int main() {
    ...
    //prepare("This is a test to see whehther the preparation Works",prepared);

    cout << "'This is a test to see whehther the preparation Works ";
    cout << "encoding as:" << endl;
    cout << "'" << prepared << "'." << endl << endl;

    //cout << static_cast<int>('0');
    //cout << static_cast<int>('9');
    //cout << static_cast<int>('A');
    //cout << static_cast<int>('Z');
    //cout << static_cast<int>('Z') - static_cast<int>('A');
