...
int main() {
  ...
  success = can_form_word_from_tiles("NEWBORN", "WBNNOER", played_tiles);
  cout << "The word 'NEWBORN' " << (success ? "can" : "cannot")
         << " be made from the tiles 'WBNNOER'" << endl;
  if (success)
    cout << "Played tiles: " << played_tiles << endl;
  cout << endl;
  ...
  score = compute_score("NEWBORN", sm1);
  cout << "NEWBORN scores " << score << endl;
